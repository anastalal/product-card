  ...
  return (
    <div className={`min-h-screen bg-gray-100 ${isRTL ? "font-arabic" : ""}`} dir={isRTL ? "rtl" : "ltr"}>
      ...
      <button
        ...
        className="fixed top-4 right-4 z-50 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-colors font-semibold shadow-lg hover:shadow-xl"
      >
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className={`text-4xl font-bold text-gray-900 mb-2 ${isRTL ? "text-right" : "text-left"}`}>
        ...
        {compareList.length > 0 && (
          <div
            className={`fixed bottom-4 bg-white rounded-lg shadow-lg p-4 border-2 border-blue-200 ${isRTL ? "left-4" : "right-4"}`}
          >
